...
function DownOpenIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 466 1000" fill="currentColor" height="100%" width="100%" {...props}>
